    ...
    return (
        <>
            <div className=" relative">
                <div className="fixed inset-0 bg-black bg-opacity-90 backdrop-blur-sm z-10">
                    <dialog
                        open={open}
                        className="bg-card-gradient rounded-lg w-2/5 min-h-2/5 max-h-fit-content p-[2px] fixed top-[50%] left-[50%] -translate-x-[60%] -translate-y-[50%]"
                    >
